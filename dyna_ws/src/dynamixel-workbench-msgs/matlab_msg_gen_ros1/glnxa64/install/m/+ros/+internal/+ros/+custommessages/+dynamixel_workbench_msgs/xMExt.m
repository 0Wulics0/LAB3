function [data, info] = xMExt
%XMExt gives an empty data for dynamixel_workbench_msgs/XMExt
...
info.MessageType = 'dynamixel_workbench_msgs/XMExt';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{21} = 'External_Port_Mode_1';
info.MatPath{22} = 'External_Port_Mode_2';
info.MatPath{23} = 'External_Port_Mode_3';
info.MatPath{24} = 'Shutdown';
info.MatPath{25} = 'Torque_Enable';
info.MatPath{26} = 'LED';
info.MatPath{27} = 'Status_Return_Level';
info.MatPath{28} = 'Registered_Instruction';
info.MatPath{29} = 'Hardware_Error_Status';
info.MatPath{30} = 'Velocity_I_Gain';
info.MatPath{31} = 'Velocity_P_Gain';
info.MatPath{32} = 'Position_D_Gain';
info.MatPath{33} = 'Position_I_Gain';
info.MatPath{34} = 'Position_P_Gain';
info.MatPath{35} = 'Feedforward_2nd_Gain';
info.MatPath{36} = 'Feedforward_1st_Gain';
info.MatPath{37} = 'Bus_Watchdog';
info.MatPath{38} = 'Goal_PWM';
info.MatPath{39} = 'Goal_Current';
info.MatPath{40} = 'Goal_Velocity';
info.MatPath{41} = 'Profile_Acceleration';
info.MatPath{42} = 'Profile_Velocity';
info.MatPath{43} = 'Goal_Position';
info.MatPath{44} = 'Realtime_Tick';
info.MatPath{45} = 'Moving';
info.MatPath{46} = 'Moving_Status';
info.MatPath{47} = 'Present_PWM';
info.MatPath{48} = 'Present_Current';
info.MatPath{49} = 'Present_Velocity';
info.MatPath{50} = 'Present_Position';
info.MatPath{51} = 'Velocity_Trajectory';
info.MatPath{52} = 'Position_Trajectory';
info.MatPath{53} = 'Present_Input_Voltage';
info.MatPath{54} = 'Present_Temperature';
