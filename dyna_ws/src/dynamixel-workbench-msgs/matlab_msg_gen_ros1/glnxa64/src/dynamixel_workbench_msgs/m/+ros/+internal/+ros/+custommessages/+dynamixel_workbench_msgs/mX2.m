function [data, info] = mX2
%MX2 gives an empty data for dynamixel_workbench_msgs/MX2
...
info.MessageType = 'dynamixel_workbench_msgs/MX2';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{16} = 'Acceleration_Limit';
info.MatPath{17} = 'Velocity_Limit';
info.MatPath{18} = 'Max_Position_Limit';
info.MatPath{19} = 'Min_Position_Limit';
info.MatPath{20} = 'Shutdown';
info.MatPath{21} = 'Torque_Enable';
info.MatPath{22} = 'LED';
info.MatPath{23} = 'Status_Return_Level';
info.MatPath{24} = 'Registered_Instruction';
info.MatPath{25} = 'Hardware_Error_Status';
info.MatPath{26} = 'Velocity_I_Gain';
info.MatPath{27} = 'Velocity_P_Gain';
info.MatPath{28} = 'Position_D_Gain';
info.MatPath{29} = 'Position_I_Gain';
info.MatPath{30} = 'Position_P_Gain';
info.MatPath{31} = 'Feedforward_2nd_Gain';
info.MatPath{32} = 'Feedforward_1st_Gain';
info.MatPath{33} = 'Bus_Watchdog';
info.MatPath{34} = 'Goal_PWM';
info.MatPath{35} = 'Goal_Velocity';
info.MatPath{36} = 'Profile_Acceleration';
info.MatPath{37} = 'Profile_Velocity';
info.MatPath{38} = 'Goal_Position';
info.MatPath{39} = 'Realtime_Tick';
info.MatPath{40} = 'Moving';
info.MatPath{41} = 'Moving_Status';
info.MatPath{42} = 'Present_PWM';
info.MatPath{43} = 'Present_Load';
info.MatPath{44} = 'Present_Velocity';
info.MatPath{45} = 'Present_Position';
info.MatPath{46} = 'Velocity_Trajectory';
info.MatPath{47} = 'Position_Trajectory';
info.MatPath{48} = 'Present_Input_Voltage';
info.MatPath{49} = 'Present_Temperature';
