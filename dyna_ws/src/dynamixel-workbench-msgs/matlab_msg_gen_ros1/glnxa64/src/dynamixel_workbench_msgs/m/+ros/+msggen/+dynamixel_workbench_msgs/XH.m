...
classdef XH < ros.Message
    %XH MATLAB implementation of dynamixel_workbench_msgs/XH
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.
    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'dynamixel_workbench_msgs/XH' % The ROS message type
    end
    ...
    methods
        function set.ModelNumber(obj, val)
            ...
            validateattributes(val, validClasses, validAttributes, 'XH', 'ModelNumber');
            obj.ModelNumber = uint16(val);
        end
        function set.FirmwareVersion(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'FirmwareVersion');
            obj.FirmwareVersion = uint8(val);
        end
        function set.ID(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'ID');
            obj.ID = uint8(val);
        end
        function set.BaudRate(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'BaudRate');
            obj.BaudRate = uint8(val);
        end
        function set.ReturnDelayTime(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'ReturnDelayTime');
            obj.ReturnDelayTime = uint8(val);
        end
        function set.DriveMode(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'DriveMode');
            obj.DriveMode = uint8(val);
        end
        function set.OperatingMode(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'OperatingMode');
            obj.OperatingMode = uint8(val);
        end
        function set.SecondaryID(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'SecondaryID');
            obj.SecondaryID = uint8(val);
        end
        function set.ProtocolVersion(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'ProtocolVersion');
            obj.ProtocolVersion = uint8(val);
        end
        function set.HomingOffset(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'HomingOffset');
            obj.HomingOffset = int32(val);
        end
        function set.MovingThreshold(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'MovingThreshold');
            obj.MovingThreshold = uint32(val);
        end
        function set.TemperatureLimit(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'TemperatureLimit');
            obj.TemperatureLimit = uint8(val);
        end
        function set.MaxVoltageLimit(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'MaxVoltageLimit');
            obj.MaxVoltageLimit = uint16(val);
        end
        function set.MinVoltageLimit(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'MinVoltageLimit');
            obj.MinVoltageLimit = uint16(val);
        end
        function set.PWMLimit(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PWMLimit');
            obj.PWMLimit = uint16(val);
        end
        function set.CurrentLimit(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'CurrentLimit');
            obj.CurrentLimit = uint16(val);
        end
        function set.AccelerationLimit(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'AccelerationLimit');
            obj.AccelerationLimit = uint32(val);
        end
        function set.VelocityLimit(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'VelocityLimit');
            obj.VelocityLimit = uint32(val);
        end
        function set.MaxPositionLimit(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'MaxPositionLimit');
            obj.MaxPositionLimit = uint32(val);
        end
        function set.MinPositionLimit(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'MinPositionLimit');
            obj.MinPositionLimit = uint32(val);
        end
        function set.Shutdown(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'Shutdown');
            obj.Shutdown = uint8(val);
        end
        function set.TorqueEnable(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'TorqueEnable');
            obj.TorqueEnable = uint8(val);
        end
        function set.LED(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'LED');
            obj.LED = uint8(val);
        end
        function set.StatusReturnLevel(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'StatusReturnLevel');
            obj.StatusReturnLevel = uint8(val);
        end
        function set.RegisteredInstruction(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'RegisteredInstruction');
            obj.RegisteredInstruction = uint8(val);
        end
        function set.HardwareErrorStatus(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'HardwareErrorStatus');
            obj.HardwareErrorStatus = uint8(val);
        end
        function set.VelocityIGain(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'VelocityIGain');
            obj.VelocityIGain = uint16(val);
        end
        function set.VelocityPGain(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'VelocityPGain');
            obj.VelocityPGain = uint16(val);
        end
        function set.PositionDGain(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PositionDGain');
            obj.PositionDGain = uint16(val);
        end
        function set.PositionIGain(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PositionIGain');
            obj.PositionIGain = uint16(val);
        end
        function set.PositionPGain(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PositionPGain');
            obj.PositionPGain = uint16(val);
        end
        function set.Feedforward2ndGain(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'Feedforward2ndGain');
            obj.Feedforward2ndGain = uint16(val);
        end
        function set.Feedforward1stGain(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'Feedforward1stGain');
            obj.Feedforward1stGain = uint16(val);
        end
        function set.BusWatchdog(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'BusWatchdog');
            obj.BusWatchdog = uint8(val);
        end
        function set.GoalPWM(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'GoalPWM');
            obj.GoalPWM = int16(val);
        end
        function set.GoalCurrent(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'GoalCurrent');
            obj.GoalCurrent = int16(val);
        end
        function set.GoalVelocity(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'GoalVelocity');
            obj.GoalVelocity = int32(val);
        end
        function set.ProfileAcceleration(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'ProfileAcceleration');
            obj.ProfileAcceleration = uint32(val);
        end
        function set.ProfileVelocity(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'ProfileVelocity');
            obj.ProfileVelocity = uint32(val);
        end
        function set.GoalPosition(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'GoalPosition');
            obj.GoalPosition = uint32(val);
        end
        function set.RealtimeTick(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'RealtimeTick');
            obj.RealtimeTick = uint16(val);
        end
        function set.Moving(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'Moving');
            obj.Moving = uint8(val);
        end
        function set.MovingStatus(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'MovingStatus');
            obj.MovingStatus = uint8(val);
        end
        function set.PresentPWM(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PresentPWM');
            obj.PresentPWM = int16(val);
        end
        function set.PresentCurrent(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PresentCurrent');
            obj.PresentCurrent = int16(val);
        end
        function set.PresentVelocity(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PresentVelocity');
            obj.PresentVelocity = int32(val);
        end
        function set.PresentPosition(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PresentPosition');
            obj.PresentPosition = int32(val);
        end
        function set.VelocityTrajectory(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'VelocityTrajectory');
            obj.VelocityTrajectory = uint32(val);
        end
        function set.PositionTrajectory(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PositionTrajectory');
            obj.PositionTrajectory = uint32(val);
        end
        function set.PresentInputVoltage(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PresentInputVoltage');
            obj.PresentInputVoltage = uint16(val);
        end
        function set.PresentTemperature(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'XH', 'PresentTemperature');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.dynamixel_workbench_msgs.XH.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.dynamixel_workbench_msgs.XH;
            obj.reload(strObj);
        end
    end
end
