...
// Common copy functions for dynamixel_workbench_msgs/GetDynamixelInfoResponse
...
namespace GetDynamixelInfoResponse {
  ...
  MDArray_T get_arr_dynamixel_workbench_msgs_DynamixelInfo(MDFactory_T& factory, const dynamixel_workbench_msgs::GetDynamixelInfoResponse::_dynamixel_info_type& val);
  ...
  //----------------------------------------------------------------------------
  DYNAMIXEL_WORKBENCH_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<dynamixel_workbench_msgs::GetDynamixelInfoResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //dynamixel_info
  ...
  //----------------------------------------------------------------------------
  DYNAMIXEL_WORKBENCH_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const dynamixel_workbench_msgs::GetDynamixelInfoResponse>& msg) {
