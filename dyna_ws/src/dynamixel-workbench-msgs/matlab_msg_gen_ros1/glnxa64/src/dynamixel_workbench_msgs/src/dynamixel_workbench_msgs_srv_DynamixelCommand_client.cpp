...
// Service Client for dynamixel_workbench_msgs/DynamixelCommandRequest
...
DYNAMIXEL_WORKBENCH_MSGS_EXPORT void copy_from_arr(dynamixel_workbench_msgs::DynamixelCommand::Request& request,
...
namespace dynamixel_workbench_msgs {
namespace matlabhelper {
namespace DynamixelCommand_Response {
DYNAMIXEL_WORKBENCH_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const dynamixel_workbench_msgs::DynamixelCommand::Response& response);
} // namespace DynamixelCommand_Response
} // namespace matlabhelper
} // namespace dynamixel_workbench_msgs
class DYNAMIXEL_WORKBENCH_MSGS_EXPORT dynamixel_workbench_msgs_srv_DynamixelCommand_client
    ...
    std::map<int64_t, dynamixel_workbench_msgs::DynamixelCommand::Request> mRequestPool;
    dynamixel_workbench_msgs::DynamixelCommand::Request mNextRequest;
  public:
    dynamixel_workbench_msgs_srv_DynamixelCommand_client()
        : MATLABSvcClientInterface()
        , mNextRequest() {
    }
    virtual ~dynamixel_workbench_msgs_srv_DynamixelCommand_client() {
    }
    virtual intptr_t createSvcClient(const std::string& srv_name,
        ...
        mClient = std::make_shared<ros::ServiceClient>(
            theNode->serviceClient<dynamixel_workbench_msgs::DynamixelCommand>(srv_name));
    ...
    virtual bool send_request(void* sd,
        ...
        dynamixel_workbench_msgs::DynamixelCommand svc;
        ...
        if (ret) {
            ...
            auto outArray =
                dynamixel_workbench_msgs::matlabhelper::DynamixelCommand_Response::get_arr(mFactory, svc.response);
            if (sd != NULL) {
    ...
    virtual bool addRequestToPool(matlab::data::Array arr) {
        ...
        dynamixel_workbench_msgs::matlabhelper::DynamixelCommand_Request::copy_from_arr(req, arr);
        mRequestPool.insert(
                {dynamixel_workbench_msgs::matlabhelper::DynamixelCommand_Request::get_requestId_from_arr(arr), 
                         req});
        return true;
    }
...
CLASS_LOADER_REGISTER_CLASS(dynamixel_workbench_msgs_srv_DynamixelCommand_client, MATLABSvcClientInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
