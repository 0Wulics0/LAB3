...
// Common copy functions for dynamixel_workbench_msgs/PROExt
...
namespace PROExt {
  //----------------------------------------------------------------------------
  DYNAMIXEL_WORKBENCH_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<dynamixel_workbench_msgs::PROExt>& msg, const matlab::data::StructArray arr) {
    try {
        //Model_Number
